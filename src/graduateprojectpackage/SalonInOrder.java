...
public class SalonInOrder {
	private WebDriver driverOpera;
	  ...
	  public void testSizes() throws Exception {
	    ...
	    HelpMethodsT.downloadPicture(driverOpera, ParametrsÒ.ownpicture2);	    
	    ...
	    String date = "15-05 12:10";

	    new Select(driverOpera.findElement(LocatorsT.selectDay)).selectByIndex(15);
	    new Select(driverOpera.findElement(LocatorsT.selectMonth)).selectByIndex(5);
